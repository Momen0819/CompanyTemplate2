...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        function mobile_menu_dim() {
            ...
            $("#navigation").width(nav_width).height(nav_height - 103);
        }
        ...
        if (!device.tablet() && !device.mobile()) {
            ...
            $('.hero.mvisible').height(windowHeight - 103); // add blog class to hero in order to show menu

        } else {
            //$('.hero-single').height(windowHeight);
            $('.hero:first').height(windowHeight);
            $('.hero.mvisible:first').height(windowHeight - 103);
            $('.hero').css("height", "initial  !important");
            $('.hero.mvisible').css("height", "initial  !important");
        ...
        $('section').each(function () {
            ...
            }, { offset: function () { return -$(this).height()  - 103   } });
        });
        ...
        function init() {
            var mapOptions = {
                scrollwheel: false,
                zoom: 19,
                center: new google.maps.LatLng(24.7855524,46.6827716), // New York
            ...
            var image = new google.maps.MarkerImage('/themes/imkan/en/images/elements/pin5.png',
                null, null, null, new google.maps.Size(116, 164))

            var myLatLng = new google.maps.LatLng(24.7855524,46.6827716);
